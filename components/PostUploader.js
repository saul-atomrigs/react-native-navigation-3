...
const uploadPostSchema = Yup.object().shape({
  postTitle: Yup.string().required('Image is required'),
...
export default function PostUploader({ navigation }) {
  ...
  const uploadPostToFirebase = (postTitle, caption) => {
    const unsubscribe = db
      .collection('users')
  ...
  return (
    <Formik
      initialValues={{ caption: '', postTitle: '' }}
      onSubmit={(values) => {
        uploadPostToFirebase(values.postTitle, values.caption)
        navigation.goBack()
      }}
